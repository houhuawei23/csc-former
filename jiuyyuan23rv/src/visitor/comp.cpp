...
//   compile_unit->newFunction(true, Type::function_t(Type::void_t(), {Type::i32_t()}), "starttime");
//   compile_unit->newFunction(true, Type::function_t(Type::void_t(), {Type::i32_t()}), "stoptime");
//   compile_unit->newFunction(
