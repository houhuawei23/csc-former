...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(3) && mir::checkISASpecificOperands(inst, ctx, 3) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(1)) &&
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(2) && mir::checkISASpecificOperands(inst, ctx, 2) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandUImm20(inst.getOperand(1));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 2;
    }
...
public:
    ...
    [[nodiscard]] InstFlag getInstFlag() const noexcept override {
        return InstFlagNone | InstFlagTerminator | InstFlagReturn | InstFlagNoFallthrough;
    }
    [[nodiscard]] std::string_view getUniqueName() const noexcept override {
        return "RISCV.RET";
    }
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(4) && mir::checkISASpecificOperands(inst, ctx, 4) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(1)) &&
            ::cmmc::mir::RISCV::isOperandReloc(inst.getOperand(2)) && ::cmmc::mir::RISCV::isOperandProb(inst.getOperand(3));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 4;
    }
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(2) && mir::checkISASpecificOperands(inst, ctx, 2) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandReloc(inst.getOperand(1));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 2;
    }
    ...
    [[nodiscard]] InstFlag getInstFlag() const noexcept override {
        return InstFlagNone | InstFlagTerminator | InstFlagIndirectJump | InstFlagNoFallthrough;
    }
    [[nodiscard]] std::string_view getUniqueName() const noexcept override {
        return "RISCV.JR";
    }
...
public:
    ...
    void print(std::ostream& out, const MIRInst& inst, bool printComment) const override {
        CMMC_UNUSED(inst);
        out << "amoadd.w.aqrl " << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(0) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(1) } << ", ("
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(2) } << ")";
        CMMC_UNUSED(printComment);
    }
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(6) && mir::checkISASpecificOperands(inst, ctx, 6) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(1)) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(2)) && ::cmmc::mir::RISCV::isOperandImm(inst.getOperand(3)) &&
            ::cmmc::mir::RISCV::isOperandImm(inst.getOperand(4)) && ::cmmc::mir::RISCV::isOperandImm(inst.getOperand(5));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 6;
    }
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(3) && mir::checkISASpecificOperands(inst, ctx, 3) &&
            ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(1)) &&
...
public:
    ...
    void print(std::ostream& out, const MIRInst& inst, bool printComment) const override {
        ...
        out << "fcvt.w.s " << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(0) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(1) } << ", rtz";
        CMMC_UNUSED(printComment);
    }
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(2) && mir::checkISASpecificOperands(inst, ctx, 2) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(1));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 2;
    }
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(2) && mir::checkISASpecificOperands(inst, ctx, 2) &&
            ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(1));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 2;
    }
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(4) && mir::checkISASpecificOperands(inst, ctx, 4) &&
            ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(1)) &&
            ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(2)) && ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(3));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 4;
    }
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(2) && mir::checkISASpecificOperands(inst, ctx, 2) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandNonZeroImm12(inst.getOperand(1));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 2;
    }
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(2) && mir::checkISASpecificOperands(inst, ctx, 2) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandNonZeroImm32(inst.getOperand(1));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 2;
    }
...
public:
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(2) && mir::checkISASpecificOperands(inst, ctx, 2) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandNonZeroImm64(inst.getOperand(1));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 2;
    }
...
public:
    ...
    void print(std::ostream& out, const MIRInst& inst, bool printComment) const override {
        CMMC_UNUSED(inst);
        out << "select_gpr_gpr " << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(0) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(1) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(2) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(3) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(4) } << ", "
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(6) && mir::checkISASpecificOperands(inst, ctx, 6) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandIRegOrImm(inst.getOperand(1)) &&
            ::cmmc::mir::RISCV::isOperandIRegOrImm(inst.getOperand(2)) && ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(3)) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(4)) && ::cmmc::mir::RISCV::isOperandCC(inst.getOperand(5));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 6;
    }
...
public:
    ...
    void print(std::ostream& out, const MIRInst& inst, bool printComment) const override {
        CMMC_UNUSED(inst);
        out << "select_gpr_arith " << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(0) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(1) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(2) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(3) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(4) } << ", "
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(7) && mir::checkISASpecificOperands(inst, ctx, 7) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(1)) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(2)) && ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(3)) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(4)) && ::cmmc::mir::RISCV::isOperandCC(inst.getOperand(5)) &&
...
public:
    ...
    void print(std::ostream& out, const MIRInst& inst, bool printComment) const override {
        CMMC_UNUSED(inst);
        out << "select_fpr_gpr " << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(0) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(1) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(2) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(3) } << ", "
            << ::cmmc::mir::RISCV::OperandDumper{ inst.getOperand(4) } << ", "
    ...
    [[nodiscard]] bool verify(const MIRInst& inst, const CodeGenContext& ctx) const override {
        return inst.checkOperandCount(6) && mir::checkISASpecificOperands(inst, ctx, 6) &&
            ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(0)) && ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(1)) &&
            ::cmmc::mir::RISCV::isOperandFPR(inst.getOperand(2)) && ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(3)) &&
            ::cmmc::mir::RISCV::isOperandGPR(inst.getOperand(4)) && ::cmmc::mir::RISCV::isOperandCC(inst.getOperand(5));
    }
    [[nodiscard]] uint32_t getOperandNum() const noexcept override {
        return 6;
