...
class RISCVScheduleModel_sifive_u74 final : public TargetScheduleModel {
    ...
    RISCVScheduleClassIntegerArithmeticLateB mScheduleClass_IntegerArithmeticLateB;
    RISCVScheduleClassIntegerArithmeticEarlyB mScheduleClass_IntegerArithmeticEarlyB;
    RISCVScheduleClassIntegerArithmeticLateAB mScheduleClass_IntegerArithmeticLateAB;
