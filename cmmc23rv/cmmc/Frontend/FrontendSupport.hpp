...
#define CMMC_ID(LOC, NAME) make<IdentifierExpr>(castLoc(LOC), std::move(NAME), IdentifierUsageHint::Unknown)
#define CMMC_FUNC_ID(LOC, NAME) make<IdentifierExpr>(castLoc(LOC), std::move(NAME), IdentifierUsageHint::Function)
